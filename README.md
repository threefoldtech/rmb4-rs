...
- e2e encryption is done by deriving an encryption key from the same identity seed, and share the public key on `registrar` hence it's available to everyone to use
